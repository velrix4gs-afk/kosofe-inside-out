...
export default function OwnerLogin() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            router.push('/owner/dashboard'); // We'll build this next!
        }
    };
    ...
    return (
        <div className="min-h-screen bg-[#f5f5f5] flex items-center justify-center px-4">
            <div className="bg-white p-8 rounded shadow-lg w-full max-w-md">
                <h1 className="text-2xl font-bold text-center mb-2 text-gray-800">Business Owner Login</h1>
                <p className="text-xs text-center text-gray-500 mb-6">Manage your directory listings and analytics.</p>
